      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-5 mx-auto mb-3 py-6 px-4 w-auto border-2 rounded-md shadow-md transition-transform transform hover:scale-105 duration-400 ease-in-out">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-2 sm:flex-row flex-col items-center">
              <Link
                href="https://auth.geeksforgeeks.org/user/vishal1829/practice/"
                target="_blank"
              >
                <Image
                  src="/gfg.jpeg"
            ...
            <div className="flex gap-2 sm:flex-row flex-col items-center">
              <Link
                href="https://www.hackerrank.com/Vishal1829?hr_r=1"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex gap-2 sm:flex-row flex-col items-center">
              <Link
                href="https://drive.google.com/file/d/1bxwuX_0M74KuQsU2OMgOv6b8H9l53qMd/view?usp=sharing"
                target="_blank"
              >
                <Image
                  src="/nitklogo.png"
